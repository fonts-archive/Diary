...
[배포처 바로가기](https://www.earlyfont.com/portfolio/EARLYFONT_DIARY)

&nbsp;

## 웹 폰트

사용하는 `font-family`의 이름은 `Diary`입니다.
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/Diary/subsets/Diary-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/Diary/subsets/Diary-dynamic-subset.css');
```
...
```css
font-family: "Diary", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
